...
</model>`}function W(d,l){let o="",g="",r="";return l.forEach((m,b)=>{const v=m.objectId,i=d.find(n=>n.id===v),a=[],c=n=>{n.type==="mesh"?a.push(n):n.subComponents.forEach(F=>c(d.find(j=>j.id===F.objectId)))};c(i);const e=a.map(n=>{const F=n.material?n.material.extruder:1;return`    <part id="${n.id}" subtype="normal_part">
...
</Relationships>`}function O(){return`<?xml version="1.0" encoding="UTF-8"?>
